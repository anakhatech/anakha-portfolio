...
export default function Projects() {
  ...
  const projects = [
    {
      ...
      icon: "🚦",
      github:
        "https://github.com/anakhatech/Urban-Traffic-Optimization",
    },
    {
  ...
  return (
    <section
      ref={sectionRef}
      id="projects"
      className={`w-full px-5 sm:px-8 lg:px-12 py-20 transition-all duration-1000 ease-out ${
        isVisible
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 text-center text-base md:text-lg max-w-3xl mx-auto mb-12">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {/* Description */}
                <p className="text-gray-400 leading-6 text-sm mb-5">
                  {project.description}
                </p>
